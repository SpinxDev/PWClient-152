 ...
 * @param[in] id The instance ID for this frame instance
 */
...
#define __itt_frame_begin_v3(domain, id)    ITTNOTIFY_VOID_D1(frame_begin_v3,domain,id)
#define __itt_frame_begin_v3_ptr			ITTNOTIFY_NAME(frame_begin_v3)
#define __itt_frame_end_v3(domain, id)      ITTNOTIFY_VOID_D1(frame_end_v3,domain,id)
