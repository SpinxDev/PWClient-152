...
namespace GNET
{
    ...
    class Skill1524Stub:public SkillStub
    {
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (30 + 40 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (30 + 40 * skill->GetLevel ()));
      ...
      Skill1524Stub ():SkillStub (1524)
        ...
        {
            return (float) (30 + 40 * skill->GetLevel ());
        }
        ...
        {
            return _snwprintf (buffer, length, format, skill->GetLevel (), 30 + 40 * skill->GetLevel (), 3 + skill->GetLevel () * 0.2);
