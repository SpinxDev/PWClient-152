      ...
      Skill2214Stub ():SkillStub (2214)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1298, 1));
            pre_skills.push_back (std::pair < ID, int >(1294, 1));
#ifdef _SKILL_SERVER
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetT0 () * 1.35);
