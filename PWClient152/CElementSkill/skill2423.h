...
namespace GNET
{
    ...
    class Skill2423Stub:public SkillStub
    {
      ...
      Skill2423Stub ():SkillStub (2423)
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * (skill->GetLevel () < 2 && skill->GetPlayer ()->GetCls () == 4 ? 0 : 100));
            skill->GetVictim ()->SetTime ((skill->GetLevel () < 2) ? 2000 : (skill->GetLevel () - 1) * 10000);
