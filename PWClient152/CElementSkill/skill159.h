#ifndef __CPPGEN_GNET_SKILL159
#define __CPPGEN_GNET_SKILL159
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill159:public Skill
    {
      public:
        enum
        { SKILL_ID = 159 };
          Skill159 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill159Stub:public SkillStub
    {
      public:
        ...
        {
            static int array[10] = { 3449, 0, 0, 3452, 0, 3454, 0, 3456, 3457, 3458 };
            return array[skill->GetLevel () - 1];
        }
