...
namespace GNET
{
    ...
    class Skill2560Stub:public SkillStub
    {
      ...
      Skill2560Stub ():SkillStub (2560)
        ...
        {
            return (float) (55.35 + 5.4 * skill->GetLevel ());
        }
        ...
        {
            static int array[10] = { 45, 49, 53, 57, 61, 65, 69, 73, 77, 81 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredSp (Skill * skill) const
        {
            static int array[10] = { 27375, 33370, 40334, 48447, 57997, 68750, 81600, 113950, 186390, 295240 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredMoney (Skill * skill) const
        {
            static int array[10] = { 2580, 2980, 3380, 3780, 6980, 14980, 51980, 131980, 251980, 451980 };
            return array[skill->GetLevel () - 1];
        }
