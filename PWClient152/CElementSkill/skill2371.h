      ...
      Skill2371Stub ():SkillStub (2371)
        {
            ...
            effect = "2Á÷ÐÇ¸ÏÔÂ.sgc";
            range.type = 1;
            doenchant = true;
            dobless = true;
            commoncooldown = 0;
            commoncooldowntime = 0;
            pre_skills.push_back (std::pair < ID, int >(403, 1));
            pre_skills.push_back (std::pair < ID, int >(419, 1));
#ifdef _SKILL_SERVER
