#ifndef __CPPGEN_GNET_SKILL188
#define __CPPGEN_GNET_SKILL188
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill188:public Skill
    {
      public:
        enum
        { SKILL_ID = 188 };
          Skill188 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill188Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill188Stub ():SkillStub (188)
        ...
        {
            static int array[10] = { 19 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredSp (Skill * skill) const
        {
            static int array[10] = { 3680 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredMoney (Skill * skill) const
        {
            static int array[10] = { 440 };
            return array[skill->GetLevel () - 1];
        }
