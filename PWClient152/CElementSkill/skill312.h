...
namespace GNET
{
    ...
    class Skill312Stub:public SkillStub
    {
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (30 * skill->GetLevel ());
      ...
      Skill312Stub ():SkillStub (312)
        ...
        {
            return (float) (30 * skill->GetLevel ());
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (),
                               30 * skill->GetLevel (), 30 + 30 * skill->GetLevel (), 50 + 50 * skill->GetLevel (), 35 - 5 * skill->GetLevel ());
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * 0.5 + 0.5 * skill->GetLevel ());
            skill->GetVictim ()->SetRatio (0.35 - 0.05 * skill->GetLevel ());
            skill->GetVictim ()->SetAmount (0.3 + 0.3 * skill->GetLevel ());
