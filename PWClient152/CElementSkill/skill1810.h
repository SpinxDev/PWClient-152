...
namespace GNET
{
    ...
    class Skill1810Stub:public SkillStub
    {
      ...
      Skill1810Stub ():SkillStub (1810)
        ...
        {
            return _snwprintf (buffer, length, format, 606);
        ...
        {
            return (float) ((player->GetMagicattack () + player->GetSoulpower () * 0.3) * (player->GetRand () < player->GetCrit () * 2 ? 1.5 : 1));
        }
