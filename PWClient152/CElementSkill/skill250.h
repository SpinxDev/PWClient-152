      ...
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (54 + 15 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (54 + 15 * skill->GetLevel ()));
                skill->SetPlus (3.6 * skill->GetLevel () * skill->GetLevel () + 127.2 * skill->GetLevel () + 466.3);
                skill->SetRatio (0);
      ...
      Skill250Stub ():SkillStub (250)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(249, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (54 + 15 * skill->GetLevel ());
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (),
                               54 + 15 * skill->GetLevel (), 3.6 * skill->GetLevel () * skill->GetLevel () + 127.2 * skill->GetLevel () + 466.3);
