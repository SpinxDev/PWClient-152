        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (1.3 * skill->GetLevel () * skill->GetLevel () + 40.3 * skill->GetLevel () + 160.3);
                skill->SetRatio (0);
      ...
      Skill1119Stub ():SkillStub (1119)
        {
            ...
            effect = "´Ì¿Í_¶ª·Éµ¶.sgc";
            range.type = 0;
            doenchant = true;
            dobless = false;
            commoncooldown = 0;
            commoncooldowntime = 0;
            pre_skills.push_back (std::pair < ID, int >(1097, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (),
                               20 + 1.5 * skill->GetLevel (),
                               10 + 5 * skill->GetLevel (),
                               1.3 * skill->GetLevel () * skill->GetLevel () + 40.3 * skill->GetLevel () + 160.3, 40 + 3 * skill->GetLevel ());
        ...
        {
            return (float) (20 + 1.5 * skill->GetLevel () + 5.5);
        }
        ...
        {
            return (float) (2 + 0.06 * skill->GetLevel ());
        }
#endif
    };
}
