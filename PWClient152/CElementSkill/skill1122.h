      ...
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (100 + 5.6 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (100 + 5.6 * skill->GetLevel ()));
                skill->SetPlus (6.3 * skill->GetLevel () * skill->GetLevel () + 226.3 * skill->GetLevel () + 1082.8);
      ...
      Skill1122Stub ():SkillStub (1122)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1123, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (100 + 5.6 * skill->GetLevel ());
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (),
                               100 + 5.6 * skill->GetLevel (),
                               50 + 5 * skill->GetLevel (),
                               6.3 * skill->GetLevel () * skill->GetLevel () + 226.3 * skill->GetLevel () + 1082.8, 25 + 2.5 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.25 + 0.025 * skill->GetLevel ());
        ...
        {
            return (float) (2 + 0.05 * skill->GetLevel ());
        }
#endif
    };
}
