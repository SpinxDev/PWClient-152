...
int  _cdecl ogg_page_version(ogg_page *og){
  return((int)(og->header[4]));
}

int  _cdecl ogg_page_continued(ogg_page *og){
  return((int)(og->header[5]&0x01));
}

int  _cdecl ogg_page_bos(ogg_page *og){
  return((int)(og->header[5]&0x02));
}

int  _cdecl ogg_page_eos(ogg_page *og){
  return((int)(og->header[5]&0x04));
}

ogg_int64_t _cdecl  ogg_page_granulepos(ogg_page *og){
