#ifndef __CPPGEN_GNET_SKILL88
#define __CPPGEN_GNET_SKILL88
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill88:public Skill
    {
      public:
        enum
        { SKILL_ID = 88 };
          Skill88 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill88Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (3.7 * skill->GetLevel () * skill->GetLevel () + 92.5 * skill->GetLevel () + 77.6);
      ...
      Skill88Stub ():SkillStub (88)
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               -6 + 15 * skill->GetLevel (),
                               50 + 5 * skill->GetLevel (),
                               3.7 * skill->GetLevel () * skill->GetLevel () + 92.5 * skill->GetLevel () + 77.6,
