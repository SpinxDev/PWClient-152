      ...
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (100 + 12 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (100 + 12 * skill->GetLevel ()));
      ...
      Skill1106Stub ():SkillStub (1106)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1104, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (100 + 12 * skill->GetLevel ());
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (), 19.5 + 0.9 * skill->GetLevel (), 100 + 12 * skill->GetLevel (), 50 + 3 * skill->GetLevel ());
        ...
        {
            return (float) (19.5 + 0.9 * skill->GetLevel () + 5.5 * 2.8);
        }
