      ...
      Skill2445Stub ():SkillStub (2445)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1699, 1));
            pre_skills.push_back (std::pair < ID, int >(1673, 1));
            pre_skills.push_back (std::pair < ID, int >(1679, 1));
#ifdef _SKILL_SERVER
