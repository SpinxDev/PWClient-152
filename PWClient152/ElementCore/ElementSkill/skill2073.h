    ...
    class Skill2073Stub:public SkillStub
    {
      ...
      Skill2073Stub ():SkillStub (2073)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount ((6 + skill->GetT0 () * 0.1 / ((skill->GetT0 () + 500) * 0.1) * 38) * skill->GetT1 ());
            skill->GetVictim ()->SetValue ((6 + skill->GetT0 () * 0.1 / ((skill->GetT0 () + 500) * 0.1) * 38) * skill->GetT1 ());
            skill->GetVictim ()->SetHpmpgennotincombat (1);
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (skill->GetT1 () * 1000);
            skill->GetVictim ()->SetAmount (25 + skill->GetT0 () * 0.1 / ((skill->GetT0 () + 500) * 0.1) * 150);
            skill->GetVictim ()->SetValue (25 + skill->GetT0 () * 0.1 / ((skill->GetT0 () + 500) * 0.1) * 150);
