...
namespace GNET
{
    ...
    class Skill1093Stub:public SkillStub
    {
      ...
      Skill1093Stub ():SkillStub (1093)
        ...
        {
            return _snwprintf (buffer, length, format, skill->GetLevel (), skill->GetLevel (), 25 - skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (25 - skill->GetLevel ());
