...
namespace GNET
{
    ...
    class Skill1400Stub:public SkillStub
    {
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (8.4 + 3.5 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (8.4 + 3.5 * skill->GetLevel ()));
      ...
      Skill1400Stub ():SkillStub (1400)
        ...
        {
            return (float) (8.4 + 3.5 * skill->GetLevel ());
        }
        ...
        {
            return (float) (15 + 0.9 * skill->GetLevel ());
        }
#ifdef _SKILL_CLIENT
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (15 + 0.9 * skill->GetLevel ());
            skill->GetVictim ()->SetAmount (100 + 400 * skill->GetLevel ());
            skill->GetVictim ()->SetValue (100 + 400 * skill->GetLevel ());
            skill->GetVictim ()->SetTransportmptopet (1);
            return true;
        }
