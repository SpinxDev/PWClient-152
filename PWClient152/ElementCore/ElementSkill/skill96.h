#ifndef __CPPGEN_GNET_SKILL96
#define __CPPGEN_GNET_SKILL96
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill96:public Skill
    {
      public:
        enum
        { SKILL_ID = 96 };
          Skill96 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill96Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill96Stub ():SkillStub (96)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(81, 1));
#ifdef _SKILL_SERVER
