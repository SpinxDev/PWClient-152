        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (5.9 * skill->GetLevel () * skill->GetLevel () + 229.5 * skill->GetLevel () + 1710.3);
      ...
      Skill2583Stub ():SkillStub (2583)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(2582, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               85 + 8.5 * skill->GetLevel (), 5.9 * skill->GetLevel () * skill->GetLevel () + 229.5 * skill->GetLevel () + 1710.3);
