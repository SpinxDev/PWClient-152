      ...
      Skill2748Stub ():SkillStub (2748)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(2557, 10));
#ifdef _SKILL_SERVER
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (4306);
            skill->GetVictim ()->SetRatio (0.80);
