      ...
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (56 + 5 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (56 + 5 * skill->GetLevel ()));
      ...
      Skill1096Stub ():SkillStub (1096)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1094, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (56 + 5 * skill->GetLevel ());
        }
        ...
        {
            return _snwprintf (buffer, length, format, skill->GetLevel (), 56 + 5 * skill->GetLevel (), 300 - 12 * skill->GetLevel ());
