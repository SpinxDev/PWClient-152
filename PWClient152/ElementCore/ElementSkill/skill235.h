...
namespace GNET
{
    ...
    class Skill235Stub:public SkillStub
    {
      ...
      Skill235Stub ():SkillStub (235)
        ...
        {
            return (float) (-5.5 + 7.5 * skill->GetLevel ());
        }
        ...
        {
            static int array[10] = { 0, 3, 8, 13, 18, 23, 28, 33, 38, 43 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredSp (Skill * skill) const
        {
            static int array[10] = { 0, 100, 800, 2100, 4100, 7000, 10900, 16100, 23000, 32000 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredMoney (Skill * skill) const
        {
            static int array[10] = { 0, 10, 90, 220, 400, 630, 1000, 1450, 1900, 2380 };
            return array[skill->GetLevel () - 1];
        }
