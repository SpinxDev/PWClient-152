#ifndef __CPPGEN_GNET_SKILL67
#define __CPPGEN_GNET_SKILL67
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill67:public Skill
    {
      public:
        enum
        { SKILL_ID = 67 };
          Skill67 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill67Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill67Stub ():SkillStub (67)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(66, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               50 + 5 * skill->GetLevel (),
                               3.8 * skill->GetLevel () * skill->GetLevel () + 237.8 * skill->GetLevel () + 3123.7, 20 + 3 * skill->GetLevel ());
