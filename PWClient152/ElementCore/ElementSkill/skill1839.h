      ...
      Skill1839Stub ():SkillStub (1839)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1876, 1));
#ifdef _SKILL_SERVER
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (0.2 + (skill->GetT0 () - skill->GetT1 () * skill->GetT1 () - 50 * skill->GetT1 ()) * 0.00001);
