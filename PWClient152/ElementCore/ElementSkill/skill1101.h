      ...
      Skill1101Stub ():SkillStub (1101)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1103, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (5 + 2.3 * skill->GetLevel ());
        }
#ifdef _SKILL_CLIENT
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (), 5 + 2.3 * skill->GetLevel (), 157.5 + 18 * skill->GetLevel (), 2 + 0.1 * skill->GetLevel ());
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * skill->GetT0 () * 0.00066);
        ...
        {
            return (float) (5 + 2.3 * skill->GetLevel () + 3 * 5.5);
        }
