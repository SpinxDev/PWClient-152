#ifndef __CPPGEN_GNET_SKILL3
#define __CPPGEN_GNET_SKILL3
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill3:public Skill
    {
      public:
        enum
        { SKILL_ID = 3 };
          Skill3 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill3Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (23.5 + 8.4 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (23.5 + 8.4 * skill->GetLevel ()));
                skill->SetPlus (2.1 * skill->GetLevel () * skill->GetLevel () + 88.8 * skill->GetLevel () + 298.6);
      ...
      Skill3Stub ():SkillStub (3)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(54, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               50 + 5 * skill->GetLevel (),
                               2.1 * skill->GetLevel () * skill->GetLevel () + 88.8 * skill->GetLevel () + 298.6, 20 + 3 * skill->GetLevel ());
