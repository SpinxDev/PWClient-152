      ...
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->SetFiredamage (4 * skill->GetMagicattack ());
      ...
      Skill1529Stub ():SkillStub (1529)
        {
            ...
            restrict_corpse = 0;
            allow_forms = 0;
            effect = "ºìÉ«»ðÑæ¹Ö¾«Ó¢_¼¼ÄÜ¹¥»÷2_»÷ÖÐ.sgc";
            range.type = 3;
            doenchant = true;
            dobless = false;
            commoncooldown = 0;
        ...
        {
            return _snwprintf (buffer, length, format, skill->GetLevel (), 0, skill->GetLevel () * 250);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetLevel () * 250);
