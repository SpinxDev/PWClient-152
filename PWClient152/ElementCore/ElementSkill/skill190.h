#ifndef __CPPGEN_GNET_SKILL190
#define __CPPGEN_GNET_SKILL190
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill190:public Skill
    {
      public:
        enum
        { SKILL_ID = 190 };
          Skill190 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill190Stub:public SkillStub
    {
      public:
        Skill190Stub ():SkillStub (190)
        {
            cls = 7;
            name = L"飞行精通";
            nativename = "飞行精通";
