      ...
      Skill246Stub ():SkillStub (246)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(245, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (),
                               21 + 7.5 * skill->GetLevel (), 6.9 * skill->GetLevel () * skill->GetLevel () + 188 * skill->GetLevel () + 539.1);
        ...
        {
            return -1000 - 200 * skill->GetLevel ();
        }
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetTime (15000);
            skill->GetVictim ()->SetAmount (6.9 * skill->GetLevel () * skill->GetLevel () + 188 * skill->GetLevel () + 539.1);
