#ifndef __CPPGEN_GNET_SKILL189
#define __CPPGEN_GNET_SKILL189
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill189:public Skill
    {
      public:
        enum
        { SKILL_ID = 189 };
          Skill189 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill189Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill189Stub ():SkillStub (189)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(18, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return 13000 - 1000 * skill->GetLevel ();
        }
        ...
        {
            return _snwprintf (buffer, length, format, skill->GetLevel (), 17.5 + 0.9 * skill->GetLevel (), 13 - skill->GetLevel ());
