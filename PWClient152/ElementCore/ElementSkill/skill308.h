      ...
      Skill308Stub ():SkillStub (308)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(307, 1));
#ifdef _SKILL_SERVER
        ...
        {
            static int array[10] = { 36, 40, 44, 48, 52, 56, 60, 64, 68, 72 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredSp (Skill * skill) const
        {
            static int array[10] = { 10000, 13150, 17100, 22050, 28300, 36200, 46200, 59000, 75500, 96000 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredMoney (Skill * skill) const
        {
            static int array[10] = { 1720, 2080, 2480, 2880, 3280, 3680, 4980, 12980, 41980, 111980 };
            return array[skill->GetLevel () - 1];
        }
