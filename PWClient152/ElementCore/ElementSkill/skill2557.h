      ...
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (151.2 + 8.1 * skill->GetLevel ());
        ...
        class State3:public SkillStub::State
        {
          public:
            ...
            {
                skill->SetSection (1);
                skill->SetPlus (4.1 * skill->GetLevel () * skill->GetLevel () + 260.7 * skill->GetLevel () + 3423.6);
      ...
      Skill2557Stub ():SkillStub (2557)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(2554, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (151.2 + 8.1 * skill->GetLevel ());
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (),
                               151.2 + 8.1 * skill->GetLevel (),
                               200 + 20 * skill->GetLevel (), 4.1 * skill->GetLevel () * skill->GetLevel () + 260.7 * skill->GetLevel () + 3423.6);
