      ...
      public:
        ...
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (22.7 + 8.1 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (22.7 + 8.1 * skill->GetLevel ()));
                skill->SetPlus (0);
                skill->SetRatio (0);
      ...
      Skill301Stub ():SkillStub (301)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(300, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (22.7 + 8.1 * skill->GetLevel ());
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               22.7 + 8.1 * skill->GetLevel (), 9.1 * skill->GetLevel () * skill->GetLevel () + 236.1 * skill->GetLevel () + 656);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (9.1 * skill->GetLevel () * skill->GetLevel () + 236.1 * skill->GetLevel () + 656);
