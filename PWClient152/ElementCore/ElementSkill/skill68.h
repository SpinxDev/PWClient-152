#ifndef __CPPGEN_GNET_SKILL68
#define __CPPGEN_GNET_SKILL68
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill68:public Skill
    {
      public:
        enum
        { SKILL_ID = 68 };
          Skill68 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill68Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill68Stub ():SkillStub (68)
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               50 + 5 * skill->GetLevel (),
                               5.7 * skill->GetLevel () * skill->GetLevel () + 191 * skill->GetLevel () + 816.1, 3 + 0.3 * skill->GetLevel ());
