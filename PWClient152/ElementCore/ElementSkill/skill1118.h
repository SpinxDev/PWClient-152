        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (9.4 * skill->GetLevel () * skill->GetLevel () + 186.1 * skill->GetLevel () + 117.1);
      ...
      Skill1118Stub ():SkillStub (1118)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1111, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               50 + 5 * skill->GetLevel (), 9.4 * skill->GetLevel () * skill->GetLevel () + 186.1 * skill->GetLevel () + 117.1);
