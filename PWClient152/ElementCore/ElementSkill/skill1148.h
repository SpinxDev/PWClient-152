        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (1.7 * skill->GetLevel () * skill->GetLevel () + 111 * skill->GetLevel () + 1457.9);
      ...
      Skill1148Stub ():SkillStub (1148)
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               1.7 * skill->GetLevel () * skill->GetLevel () + 111 * skill->GetLevel () + 1457.9, 20 + 2 * skill->GetLevel ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (20 + 2 * skill->GetLevel ());
