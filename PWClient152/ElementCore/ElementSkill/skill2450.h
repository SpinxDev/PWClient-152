      ...
      Skill2450Stub ():SkillStub (2450)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1740, 1));
            pre_skills.push_back (std::pair < ID, int >(1738, 1));
#ifdef _SKILL_SERVER
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetRatio (1732);
            skill->GetVictim ()->SetAmount (1);
            skill->GetVictim ()->SetValue (1737);
            skill->GetVictim ()->SetBeattackattachstate8 (1);
            return true;
        }
