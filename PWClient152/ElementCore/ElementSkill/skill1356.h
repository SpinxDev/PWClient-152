        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (2.2 * skill->GetLevel () * skill->GetLevel () + 130.2 * skill->GetLevel () + 951.4);
      ...
      Skill1356Stub ():SkillStub (1356)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1354, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (),
                               49 + 5.6 * skill->GetLevel (),
                               8 + 0.4 * skill->GetLevel (), 2.2 * skill->GetLevel () * skill->GetLevel () + 130.2 * skill->GetLevel () + 951.4);
