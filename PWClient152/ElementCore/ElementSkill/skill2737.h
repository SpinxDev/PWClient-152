      ...
      Skill2737Stub ():SkillStub (2737)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(2551, 10));
#ifdef _SKILL_SERVER
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (skill->GetT1 () * 1.43 + 2000);
