        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (2.2 * skill->GetLevel () * skill->GetLevel () + 140.1 * skill->GetLevel () + 1840.7);
      ...
      Skill1133Stub ():SkillStub (1133)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1107, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               50 + 5 * skill->GetLevel (),
                               2.2 * skill->GetLevel () * skill->GetLevel () + 140.1 * skill->GetLevel () + 1840.7,
                               75 + skill->GetLevel (), 3 + 0.3 * skill->GetLevel ());
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * 75 + skill->GetLevel ());
        ...
        {
            return (float) (19.5 + 0.9 * skill->GetLevel () + 2.2 * 5.5);
        }
