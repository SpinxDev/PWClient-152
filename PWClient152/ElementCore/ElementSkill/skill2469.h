    ...
    class Skill2469Stub:public SkillStub
    {
      ...
      Skill2469Stub ():SkillStub (2469)
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetTime (skill->GetLevel () == 1 ? 2000 : skill->GetLevel () * 10000);
            skill->GetVictim ()->SetRatio (2);
            skill->GetVictim ()->SetAmount (10000000);
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetMaxhp () * 0.002 * skill->GetLevel ());
            skill->GetVictim ()->SetHealshield (1);
            return true;
        }
