        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (2.4 * skill->GetLevel () * skill->GetLevel () + 153.5 * skill->GetLevel () + 1069.8);
                skill->SetRatio (0);
      ...
      Skill251Stub ():SkillStub (251)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(250, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               2.4 * skill->GetLevel () * skill->GetLevel () + 153.5 * skill->GetLevel () + 1069.8, 6 + 0.3 * skill->GetLevel ());
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (6 + 0.3 * skill->GetLevel ());
