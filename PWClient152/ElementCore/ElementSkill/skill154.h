#ifndef __CPPGEN_GNET_SKILL154
#define __CPPGEN_GNET_SKILL154
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill154:public Skill
    {
      public:
        enum
        { SKILL_ID = 154 };
          Skill154 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill154Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
      ...
      Skill154Stub ():SkillStub (154)
        ...
        {
            skill->GetPlayer ()->SetAdddefence (0.1 + 0.05 * skill->GetLevel ());
            return true;
        }
