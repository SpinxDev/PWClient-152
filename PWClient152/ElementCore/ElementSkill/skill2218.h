      ...
      Skill2218Stub ():SkillStub (2218)
        {
            cls = 6;
            name = L"Ðþ¡¤ÉßÐ«Ö®ÎÇ";
            nativename = "Ðþ¡¤ÉßÐ«Ö®ÎÇ";
            icon = "Ðþ¡¤ÉßÐ«Ö®ÎÇ.dds";
            max_level = 1;
            type = 1;
            apcost = 0;
            arrowcost = 1;
            ...
            pre_skills.push_back (std::pair < ID, int >(616, 1));
            pre_skills.push_back (std::pair < ID, int >(618, 1));
#ifdef _SKILL_SERVER
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (1.3 * skill->GetT0 ());
