      ...
      Skill552Stub ():SkillStub (552)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(15, 10));
#ifdef _SKILL_SERVER
        ...
        {
            return _snwprintf (buffer, length, format, 1200, 20, 1600, 25);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetMagicdamage () * 0.25 + 1600);
