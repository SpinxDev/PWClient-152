...
namespace GNET
{
    ...
    class Skill796Stub:public SkillStub
    {
      public:
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            {
                skill->SetRatio (-1);
                skill->SetPlus (skill->GetPlayer ()->GetMaxhp () * (0.1 + 0.05 * skill->GetLevel ()));
      ...
      Skill796Stub ():SkillStub (796)
        ...
        {
            static int array[10] = { 40, 60, 80 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredSp (Skill * skill) const
        {
            static int array[10] = { 40000, 60000, 80000 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredItem (Skill * skill) const
        {
            static int array[10] = { 11708, 11689, 11689 };
            return array[skill->GetLevel () - 1];
        }
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (skill->GetT0 () * (0.1 + 0.05 * skill->GetLevel ()));
        ...
        {
            skill->GetVictim ()->SetProbability (1.0 * 100);
            skill->GetVictim ()->SetValue (skill->GetPlayer ()->GetMaxhp () * (0.1 + 0.05 * skill->GetLevel ()));
