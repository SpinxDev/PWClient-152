#ifndef __CPPGEN_GNET_SKILL103
#define __CPPGEN_GNET_SKILL103
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill103:public Skill
    {
      public:
        enum
        { SKILL_ID = 103 };
          Skill103 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill103Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
