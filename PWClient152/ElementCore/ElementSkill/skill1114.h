      ...
      Skill1114Stub ():SkillStub (1114)
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               50 + 5 * skill->GetLevel (), 15.9 * skill->GetLevel () * skill->GetLevel () + 261.4 * skill->GetLevel () + 6.5);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (15.9 * skill->GetLevel () * skill->GetLevel () + 261.4 * skill->GetLevel () + 6.5);
        ...
        {
            return (float) (1.5 + 0.06 * skill->GetLevel ());
        }
#endif
    };
}
