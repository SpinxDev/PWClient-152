 /*
 * FILE: PlayerPassMapGenerator.cpp
 *
...
void CPlayerPassMapGenerator::Transf2DTo3D(const SAMPLE_POS& sPos, A3DVECTOR3& vPos)
{
	vPos.y = sPos.h;
...
void CPlayerPassMapGenerator::Transf3DTo2D(const A3DVECTOR3& vPos, SAMPLE_POS& sPos)
{
	sPos.h = vPos.y;
...
void CPlayerPassMapGenerator::ExpandPassRegion(const SAMPLE_POS& posSeed)
{
	// 越界
...
bool CPlayerPassMapGenerator::CanPFMove(const SAMPLE_POS& posFrom, SAMPLE_POS& posTo)
{
	//////////////////////////////////////////////////////////////////////////
...
CPlayerPassMapGenerator::SAMPLE_POS CPlayerPassMapGenerator::GenSeedPos()
{
	SAMPLE_POS seed;
...
//////////////////////////////////////////////////////////////////////////
bool CPlayerPassMapGenerator::IsSeedPosValid(SAMPLE_POS& posSeed)
{
	// 合法位置，且未计算过
...
{
	int nCalScale = 100;
	for (int x=nCalScale/2; x<m_iWidth; x+=nCalScale)
	{
		for (int z=nCalScale/2; z<m_iLength; z+=nCalScale)
		{
			SAMPLE_POS seed = {x, z, 0.0f};
...
bool CPlayerPassMapGenerator::SearchValidSeed(int iTryTimes, SAMPLE_POS& seed)
{
...
void CPlayerPassMapGenerator::SetPosReachable(const SAMPLE_POS& sPos)
{
...
void CPlayerPassMapGenerator::SetPosUnreachable(const SAMPLE_POS& sPos)
{
...
bool CPlayerPassMapGenerator::IsPosReachable(const SAMPLE_POS& sPos)
{
...
float CPlayerPassMapGenerator::GetPosDeltaHeight(const SAMPLE_POS& sPos)
{
