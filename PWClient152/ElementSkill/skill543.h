      ...
      Skill543Stub ():SkillStub (543)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(113, 10));
#ifdef _SKILL_SERVER
        ...
        {
            return _snwprintf (buffer, length, format, 28, 535, 1375, 50);
        ...
        bool StateAttack (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetValue (skill->GetMagicdamage () * 0.5 + 1375);
