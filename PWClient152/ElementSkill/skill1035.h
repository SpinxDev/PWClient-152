...
namespace GNET
{
    ...
    class Skill1035Stub:public SkillStub
    {
      ...
      Skill1035Stub ():SkillStub (1035)
        ...
        {
            static int array[10] = { 5050046, 5050051, 5050056, 5050061, 5050066, 5050071, 5050076, 5050081, 5050086, 5050091 };
            return array[skill->GetLevel () - 1];
        }
        int GetRequiredSp (Skill * skill) const
        {
            static int array[10] = { 7780, 10640, 14480, 19660, 26600, 36200, 59000, 96800, 154600, 241600 };
            return array[skill->GetLevel () - 1];
        }
