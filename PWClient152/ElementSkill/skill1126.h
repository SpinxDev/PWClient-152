...
namespace GNET
{
    ...
    class Skill1126Stub:public SkillStub
    {
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (4.1 * skill->GetLevel () * skill->GetLevel () + 92.6 * skill->GetLevel () + 36.6);
      ...
      Skill1126Stub ():SkillStub (1126)
        ...
        {
            return (float) (-9 + 15 * skill->GetLevel ());
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               -9 + 15 * skill->GetLevel (),
                               50 + 5 * skill->GetLevel (),
                               4.1 * skill->GetLevel () * skill->GetLevel () + 92.6 * skill->GetLevel () + 36.6,
                               20 + 3 * skill->GetLevel (), 5 + 0.3 * skill->GetLevel ());
