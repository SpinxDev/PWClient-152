        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                ...
                skill->SetPlus (4 * skill->GetLevel () * skill->GetLevel () + 254.9 * skill->GetLevel () + 3346.8);
      ...
      Skill1134Stub ():SkillStub (1134)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(1140, 1));
#ifdef _SKILL_SERVER
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               ...
                               4 * skill->GetLevel () * skill->GetLevel () + 254.9 * skill->GetLevel () + 3346.8, 50 + 3 * skill->GetLevel ());
        ...
        {
            return 550 * skill->GetLevel ();
        }
        bool StateAttack (Skill * skill) const
        {
            skill->GetVictim ()->SetProbability (1.0 * 50 + 3 * skill->GetLevel ());
