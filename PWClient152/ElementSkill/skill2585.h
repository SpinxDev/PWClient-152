      ...
      Skill2585Stub ():SkillStub (2585)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(2584, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return (float) (313.2 + 16.2 * skill->GetLevel ());
        }
        ...
        {
            return 45000 - 1500 * skill->GetLevel ();
        }
        ...
        int GetIntroduction (Skill * skill, wchar_t * buffer, int length, wchar_t * format) const
        {
            return _snwprintf (buffer, length, format,
                               skill->GetLevel (), 16.5 + 0.9 * skill->GetLevel (), 313.2 + 16.2 * skill->GetLevel (), 45 - 1.5 * skill->GetLevel ());
        ...
        bool BlessMe (Skill * skill) const
        {
            ...
            skill->GetVictim ()->SetAmount (1);
            skill->GetVictim ()->SetValue (45989);
