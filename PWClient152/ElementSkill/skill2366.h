      ...
      Skill2366Stub ():SkillStub (2366)
        {
            cls = 5;
            name = L"Ðþ¡¤ÉñÍþÓü";
            nativename = "Ðþ¡¤ÉñÍþÓü";
            icon = "Ðþ¡¤É±Â¾Ê¢Ñç.dds";
            max_level = 1;
            type = 1;
            apcost = 200;
            arrowcost = 0;
            ...
            pre_skills.push_back (std::pair < ID, int >(1290, 1));
            pre_skills.push_back (std::pair < ID, int >(1304, 1));
#ifdef _SKILL_SERVER
