#ifndef __CPPGEN_GNET_SKILL191
#define __CPPGEN_GNET_SKILL191
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill191:public Skill
    {
      public:
        enum
        { SKILL_ID = 191 };
          Skill191 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill191Stub:public SkillStub
    {
      public:
#ifdef _SKILL_SERVER
        class State1:public SkillStub::State
        {
          public:
            ...
            {
                skill->GetPlayer ()->SetDecmp (0.2 * (39 + 9 * skill->GetLevel ()));
        ...
        class State2:public SkillStub::State
        {
          public:
            ...
            void Calculate (Skill * skill) const
            {
                skill->GetPlayer ()->SetDecmp (0.8 * (39 + 9 * skill->GetLevel ()));
      ...
      Skill191Stub ():SkillStub (191)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(120, 1));
#ifdef _SKILL_SERVER
        ...
        {
            static int array[10] = { 320, 440, 580, 730, 1000, 1270, 1540, 1810, 2080, 2380 };
            return array[skill->GetLevel () - 1];
        }
