      ...
      Skill2264Stub ():SkillStub (2264)
        {
            ...
            pre_skills.push_back (std::pair < ID, int >(476, 1));
            pre_skills.push_back (std::pair < ID, int >(480, 1));
#ifdef _SKILL_SERVER
        ...
        {
            return _snwprintf (buffer, length, format, 30, 320);
