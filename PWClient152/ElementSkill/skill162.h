#ifndef __CPPGEN_GNET_SKILL162
#define __CPPGEN_GNET_SKILL162
namespace GNET
{
#ifdef _SKILL_SERVER
    class Skill162:public Skill
    {
      public:
        enum
        { SKILL_ID = 162 };
          Skill162 ():Skill (SKILL_ID)
        {
        }
    };
#endif
    class Skill162Stub:public SkillStub
    {
      public:
        Skill162Stub ():SkillStub (162)
        {
            cls = 4;
            name = L"斧锤精通";
            nativename = "斧锤精通";
        ...
        {
            skill->GetPlayer ()->SetInchammer (0.06 * skill->GetLevel ());
            return true;
        }
